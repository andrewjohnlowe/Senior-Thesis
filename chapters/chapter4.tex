...
\begin{figure}
\includegraphics[width=\textwidth]{figures/btagging/phase_gaia_b_versus_jfcharm.pdf}
\caption[The ATLAS detector]{Iso-$\varepsilon$ plot of GAIA B versus JetFitterCharm.
\label{fig:gbjfcphase}}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{figures/btagging/phase_gaia_c_versus_jfcharm.pdf}
...
Text here
\begin{figure}
\includegraphics[width=\textwidth]{figures/btagging/phase_gaia_b_versus_gaia_c.pdf}
